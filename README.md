# Api resultados - Java Client

API para la extracción de información de solicitudes de crédito.<br/><br/><img src="https://developer.circulodecredito.com.mx/sites/default/files/2020-10/circulo_de_credito-apihub.png" height="40" width="220"/></p><br/>
...
En el archivo ***SolicitudDeCreditoApiTest.java***, que se encuentra en ***src/test/java/mx/com/cdc/client/api***. Se deberá modificar los datos de la petición y los datos de consumo:
...
package mx.com.cdc.client.api;
    ...
    private final SolicitudDeCreditoApi api = new SolicitudDeCrditoApi();
